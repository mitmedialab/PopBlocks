...
goog.provide('Blockly.FieldIconMenu2');
 ...
 * @constructor
 */
Blockly.FieldIconMenu2 = function(icons) {
  /** @type {object} */
  this.icons_ = icons;
  // Example:
  ...
  Blockly.FieldIconMenu2.superClass_.constructor.call(this, defaultValue);
  this.addArgType('iconmenu');
};
goog.inherits(Blockly.FieldIconMenu2, Blockly.Field);
 ...
 * @const
 */
Blockly.FieldIconMenu2.DROPDOWN_WIDTH = 168;
 ...
 * @private
 */
Blockly.FieldIconMenu2.savedPrimary_ = null;

/**
 * Called when the field is placed on a block.
 * @param {Block} block The owning block.
 */
Blockly.FieldIconMenu2.prototype.init = function(block) {
  ...
  Blockly.FieldIconMenu2.superClass_.init.call(this, block);
};
 ...
 * @const
 */
Blockly.FieldIconMenu2.prototype.CURSOR = 'default';
 ...
 * @override
 */
Blockly.FieldIconMenu2.prototype.setValue = function(newValue) {
  ...
  this.setDropdownImage(this.getSrcForValue(this.value_));
};
 ...
 * @private
 */
Blockly.FieldIconMenu2.prototype.setParentFieldImage = function(src) {
 ...
 * @private
 */
Blockly.FieldIconMenu2.prototype.setDropdownImage = function(src) {
  //this.arrowIcon_.setAttributeNS('http://www.w3.org/1999/xlink',
  //    'xlink:href', Blockly.mainWorkspace.options.pathToMedia + 'dropdown-arrow.svg');
  // Only attempt if we have a set sourceBlock_
  if (this.sourceBlock_) {
    ...
    for (var i = 0, input; input = sourceBlock.inputList[i]; i++) {
      for (var j = 0, field; field = input.fieldRow[j]; j++) {
        if (field instanceof Blockly.FieldIconMenu2) {
          // Src for a FieldImage is stored in its value.
          if (field.arrowIcon_) {
 ...
 */
Blockly.FieldIconMenu2.prototype.getValue = function() {
  return this.value_;
};
 ...
 */
Blockly.FieldIconMenu2.prototype.getSrcForValue = function(value) {
 ...
 * @private
 */
Blockly.FieldIconMenu2.prototype.showEditor_ = function() {
 ...
 * @private
 */
Blockly.FieldIconMenu2.prototype.buttonClick_ = function(e) {
 ...
 */
Blockly.FieldIconMenu2.prototype.onHide_ = function() {
