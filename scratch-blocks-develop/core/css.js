...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.scratchCategoryMenuItem:hover {',
    /*background-color: $colour_toolboxHover;',*/
    'box-shadow:inset 0 0 10px 0 rgba(0, 0, 0, 0.8), 0 6px 20px 0 rgba(0, 0, 0, 0.19);',
    
  '}',

  '.scratchCategoryMenuItem.categorySelected {',
    'box-shadow:inset 0 0 10px 0 rgba(0, 0, 0, 1), 0 6px 20px 0 rgba(0, 0, 0, 0.19);',
  '}',
