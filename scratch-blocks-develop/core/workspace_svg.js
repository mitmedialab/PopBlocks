...
/**
 * The workspace's play controls (if any).
 * @type {Blockly.PlayControls}
 */
...
/**
 * Add play controls.
 * @param {number} bottom Distance from workspace bottom to bottom of play controls.
 * @return {number} Distance from workspace bottom to the top of play controls.
 * @private
 */
Blockly.WorkspaceSvg.prototype.addPlayControls_ = function(bottom) {
  /** @type {Blockly.PlayControls} */
  this.playControls = new Blockly.PlayControls(this);
